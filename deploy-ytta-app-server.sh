...
sed -i -e "s|AWS_ACCESS_KEY_ID_VALUE|$AWS_ACCESS_KEY_ID|g" ytta-app-backend-deployment-with-secrets.yaml
sed -i -e "s|AWS_SECRET_ACCESS_KEY_VALUE|$AWS_SECRET_ACCESS_KEY|g" ytta-app-backend-deployment-with-secrets.yaml
sed -i -e "s|AWS_DEFAULT_REGION_VALUE|$AWS_DEFAULT_REGION|g" ytta-app-backend-deployment-with-secrets.yaml
sed -i -e "s|SQS_URL_VALUE|$SQS_URL|g" ytta-app-backend-deployment-with-secrets.yaml
